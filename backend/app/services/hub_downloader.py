...
``minilm_service`` singleton. The retired models (XGBoost, mDeBERTa,
XLM-RoBERTa) are no longer downloaded here.
...
def ensure_hub_artifacts() -> bool:
    ...
    # inference. The retired models (XGBoost, mDeBERTa, XLM-RoBERTa) are
